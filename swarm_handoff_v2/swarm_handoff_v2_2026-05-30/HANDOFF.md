...
**H4. Cursos requeridos.** Todo curso `is_required=True` del request DEBE asignarse.
...
- **97.64% de cobertura por estudiante** (497/509 completos — incluyendo propuestas)
- **95.48% publicado** (486/509 confirmados — 12 estudiantes requieren conversación familiar con AP no acomodables)
- **99.7% de requests satisfechos** (~4,597/4,610)
- **Cero violaciones de hard constraints**

**Si tu output reporta >97.64% cobertura PERO viola hard constraints, está hacieno trampa.** El problema tiene un techo estructural: 12 alumnos con cursos AP rígidos cuyos slots no encajan en sus horarios. Llegar a 100% es imposible sin abrir nuevas secciones, lo cual el constraint H5 no permite.
