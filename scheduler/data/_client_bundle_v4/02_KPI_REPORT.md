...
|---|---|---|---|
| Fully scheduled students | 57.4% | ≥98% | ❌ |
| Required course fulfillment | 94.8% | ≥98% | ❌ |
| First-choice electives | 0.0% | ≥80% | ❌ |
| Section balance (max dev from mean) | 4 students | ≤3 | ❌ |
| Unscheduled (missing required) | 217 | 0 | ❌ |
